package com.nopcommerce.page.customlisteners;
...
import static com.nopcommerce.page.utilities.Utility.takeScreenShot;
...
public class CustomListeners implements ITestListener {
    ...
    public void onTestSuccess(ITestResult iTestResult) {
        ...
        test.log(Status.PASS, "TEST PASS IS " + iTestResult.getThrowable());
